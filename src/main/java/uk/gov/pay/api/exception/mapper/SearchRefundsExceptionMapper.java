...
import static uk.gov.pay.api.model.RefundError.Code.SEARCH_REFUNDS_CONNECTOR_ERROR;
import static uk.gov.pay.api.model.RefundError.Code.SEARCH_REFUNDS_NOT_FOUND;
