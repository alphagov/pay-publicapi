...
public class SearchChargesExceptionMapper implements ExceptionMapper<SearchException> {
    ...
    private Response buildResponse(SearchException exception, PaymentError.Code searchPaymentsConnectorError, Response.Status status) {
