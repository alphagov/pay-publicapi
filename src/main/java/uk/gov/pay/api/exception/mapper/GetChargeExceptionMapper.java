...
import static uk.gov.pay.api.model.PaymentErrorCodes.GET_PAYMENT_CONNECTOR_ERROR;
import static uk.gov.pay.api.model.PaymentErrorCodes.GET_PAYMENT_NOT_FOUND_ERROR;
