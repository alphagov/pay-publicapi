...
public class TelephonePaymentResponse {
    ...
    public static TelephonePaymentResponse from(ChargeFromResponse chargeFromResponse) {
        return new TelephonePaymentResponse.Builder()
                ...
                .withNameOnCard(chargeFromResponse.getCardDetails() != null ? chargeFromResponse.getCardDetails().getCardHolderName() : null)
                .withCardExpiry(chargeFromResponse.getCardDetails() != null  ? chargeFromResponse.getCardDetails().getExpiryDate() : null)
                .withLastFourDigits(chargeFromResponse.getCardDetails() != null ? chargeFromResponse.getCardDetails().getLastDigitsCardNumber() : null)
                .withFirstSixDigits(chargeFromResponse.getCardDetails() != null ? chargeFromResponse.getCardDetails().getFirstDigitsCardNumber() : null)
