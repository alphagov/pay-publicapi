...
public class GetPaymentEventServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        getPaymentEventService = new GetPaymentEventService(client, connectorUriGenerator, publicApiUriGenerator);
    }
    ...
    public void shouldReturnPaymentEvents() {
        ...
        PaymentEventsResponse paymentEventsResponse = getPaymentEventService.getPaymentEvent(account, "abc123");
