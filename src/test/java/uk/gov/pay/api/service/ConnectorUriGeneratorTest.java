...
public class ConnectorUriGeneratorTest {
    ...
    public void buildEventsURIFromBeforeParameter() throws Exception {
        ...
        assertThat(URLDecoder.decode(uri, "UTF-8"), is("https://bla.test/v1/events?before=2018-03-13T10:00:05Z&page=1&page_size=500"));
    }
    ...
    public void buildEventsURIFromAfterParameter() throws UnsupportedEncodingException {
        ...
        assertThat(URLDecoder.decode(uri, "UTF-8"), is("https://bla.test/v1/events?after=2018-03-13T10:00:05Z&page=1&page_size=500"));
    }
    ...
    public void buildEventsURIFromAgreementIdParameter() {
        ...
        assertThat(uri, is("https://bla.test/v1/events?mandate_external_id=1&page=1&page_size=500"));
    }
    ...
    public void buildEventsURIFromAllParameters() throws UnsupportedEncodingException {
        ...
        assertThat(URLDecoder.decode(uri, "UTF-8"), is("https://bla.test/v1/events?before=2018-03-13T10:00:05Z&after=2018-03-13T10:00:05Z&mandate_external_id=1&transaction_external_id=2&page=1&page_size=300"));
    }
}
