...
public class PaymentSearchValidatorTest {
    ...
    public void validateParams_reference_shouldGiveAnErrorValidation() throws Exception {
        ...
        expectedException.expect(aValidationExceptionContaining(aPaymentError(Code.P0401, "Invalid parameters: reference. See Public API documentation for the correct data formats")));
    ...
    public void validateParams_status_shouldGiveAnErrorValidation() throws Exception {
        ...
        expectedException.expect(aValidationExceptionContaining(aPaymentError(Code.P0401, "Invalid parameters: status. See Public API documentation for the correct data formats")));
    ...
    public void validateParams_toDate_shouldGiveAnErrorValidation() throws Exception {
        ...
        expectedException.expect(aValidationExceptionContaining(aPaymentError(Code.P0401, "Invalid parameters: to_date. See Public API documentation for the correct data formats")));
    ...
    public void validateParams_fromDate_shouldGiveAnErrorValidation() throws Exception {
        ...
        expectedException.expect(aValidationExceptionContaining(aPaymentError(Code.P0401, "Invalid parameters: from_date. See Public API documentation for the correct data formats")));
    ...
    public void validateParams_shouldGiveAnErrorValidation_forAllParams() throws Exception {
        ...
        expectedException.expect(aValidationExceptionContaining(aPaymentError(Code.P0401, "Invalid parameters: status, reference, from_date, to_date. See Public API documentation for the correct data formats")));
