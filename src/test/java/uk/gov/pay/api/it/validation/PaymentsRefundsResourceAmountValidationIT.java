...
class PaymentsRefundsResourceAmountValidationIT extends PaymentResourceITestBase {
    ...
    @Test
    void createPaymentRefund_responseWith422_whenAmountIsNegative() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": -123\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith422_whenAmountIsBiggerThanTheMaximumAllowed() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": 10000001\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountFieldHasNullValue() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": null\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountFieldIsNotNumeric() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": \"hola world!\"\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountFieldIsNotAValidJsonField() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": {\n" +
                "    \"whatever\": 1\n" +
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountFieldIsBlank() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": \"    \"\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountFieldIsMissing() throws IOException {
        // language=JSON
        String payload = "{}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountIsHexadecimal() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": 0x1000\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountIsBinary() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": 0B101\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountIsOctal() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": 017\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountIsNullByteEncoded() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": %00\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenAmountIsFloat() throws IOException {
        // language=JSON
        String payload = "{\n" +
                "  \"amount\": 27.55\n" +
                "}";
    ...
    @Test
    void createPaymentRefund_responseWith400_whenConnectorResponseIsErrorDueToAmountRequestedIsNotAvailableForRefund() throws IOException {
        int amount = 1000;
    ...
    @Test
    void createPaymentRefund_responseWith400_whenConnectorResponseIsErrorDueToChargeStatusMakesPaymentNonRefundable() throws IOException {
        int amount = 1000;
        String externalChargeId = "charge_12345";
