...
class PaymentOutcomeValidationIT extends TelephonePaymentResourceITBase {
    ...
    @Test
    void respondWith422_whenStatusIsOtherThanSuccessOrFailed() {
    ...
    @Test
    void respondWith422_whenPaymentOutcomeIsNull() {
    ...
    @Test
    void respondWith422_whenPaymentOutcomeIsMissing() {
        postPaymentResponse(toJson(requestBody))
                .statusCode(422);
    }
}
