...
public class AgreementsIT extends PaymentResourceITestBase {
    ...
    public void searchAgreementsFromLedger() {
        ...
        given().port(app.getLocalPort())
                ...
                .body("results[0].id", is(fixture1.getExternalId()))
                .body("results[0].service_id", is(fixture1.getServiceId()))
                ...
                .body("results[1].id", is(fixture2.getExternalId()))
                .body("results[1].service_id", is(fixture2.getServiceId()))
