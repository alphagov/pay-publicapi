...
class PaymentsResourceMetadataValidationFailuresIT extends PaymentResourceITestBase {

    private static final CreateChargeRequestParamsBuilder createChargeRequestParamsBuilder = aCreateChargeRequestParams()
            .withAmount(100)
    ...
    @Test
    void valueIsNotAStringBooleanOrNumber() {
    ...
    void keyIsInvalid() {
        var emptyStringKey = "";
        var createChargeRequestParams = createChargeRequestParamsBuilder.withMetadata(Map.of(emptyStringKey, "boo")).build();
