...
public abstract class BaseConnectorMockClientJUnit5 {
    ...
    WireMockExtension wireMockClassRule;

    BaseConnectorMockClientJUnit5(WireMockExtension wireMockClassRule) {
